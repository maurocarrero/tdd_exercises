...
public class KingTest {
	...
	public void constructTest() {
		Pieza rey = new King(EnumBando.blanco, 3, 5);
		Assert.assertNotNull(rey);
	}
	...
	public void posiblesMovimientosReinaTest() {
		...
		List<int[]> movs = rey.getPosiblesMovimientos();
		
		Assert.assertEquals(8, movs.size());
		
		int[] expectedMov1 = {3, 4};
		int[] expectedMov2 = {4, 4};
		int[] expectedMov3 = {4, 5};
		int[] expectedMov4 = {4, 6};
		int[] expectedMov5 = {3, 6};
		int[] expectedMov6 = {2, 6};
		int[] expectedMov7 = {2, 5};
		int[] expectedMov8 = {2, 4};
		...
		rey = new King(EnumBando.negro, 6, 2);
		movs = rey.getPosiblesMovimientos();
		
		Assert.assertEquals(8, movs.size());
		
		int[] expectedMov1_2 = {6, 1};
		int[] expectedMov2_2 = {7, 1};
		int[] expectedMov3_2 = {7, 2};
		int[] expectedMov4_2 = {7, 3};
		int[] expectedMov5_2 = {6, 3};
		int[] expectedMov6_2 = {5, 3};
		int[] expectedMov7_2 = {5, 2};
		int[] expectedMov8_2 = {5, 1};
	...
	public void attackTest() {
		Pieza rey = new King(EnumBando.negro, 3, 5);
		int[] posicionReyBlanco = { 0, 2 };
		Assert.assertFalse(rey.attack(posicionReyBlanco, this._tablero1));
		...
		Assert.assertTrue(rey.attack(posicionReyBlanco, this._tablero1));
