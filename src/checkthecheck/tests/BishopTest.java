...
public class BishopTest {
	...
	public void constructTest() {
		Pieza alfil = new Bishop(EnumBando.blanco, 3, 5);
		Assert.assertNotNull(alfil);
	}
	
	@Test
	public void posiblesMovimientosAlfilTest() {
		Pieza alfil = new Bishop(EnumBando.blanco, 3, 5);
		
		List<int[]> movs = alfil.getPosiblesMovimientos();
		
		Assert.assertEquals(11, movs.size());
		...
		alfil = new Bishop(EnumBando.negro, 6, 2);
		movs = alfil.getPosiblesMovimientos();
		
		Assert.assertEquals(9, movs.size());
	...
	public void attackTest() {
		Pieza bishop = new Bishop(EnumBando.negro, 3, 5);
		int[] posicionReyBlanco = { 0, 2 };
		Assert.assertTrue(bishop.attack(posicionReyBlanco, this._tablero1));
		...
		Assert.assertFalse(bishop.attack(posicionReyBlanco, this._tablero1));
